...
Installation
Clone this repository: git clone "https://github.com/AngeCK98/AirBnB_clone_3.git"
...
def test_pep8_conformance_test_review(self) - Test that tests/test_mode
ls/test_review.py conforms to PEP8
